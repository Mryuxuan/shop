...
var OxO5e41=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxO5e41[1],true)[OxO5e41[0]]=function (){if(event[OxO5e41[2]]){alert(element[OxO5e41[3]].cssText);} ;} ;
</script>
